...
static const k_sensor_mode sensor_csi0_mode_list[] = {
    {
        .index = 0,
        .sensor_type = BF3238_MIPI_CSI0_1920X1080_30FPS_10BIT_LINEAR,
        .size =
            {
                .bounds_width = 1920,
                .bounds_height = 1080,
...
#if defined(MPP_ENABLE_SENSOR_BF3238_ON_CSI0_USE_CHIP_CLK)
    ...
    {
        .index = 1,
        .sensor_type = BF3238_MIPI_CSI0_1280X960_30FPS_10BIT_LINEAR,
        .size =
            {
                .bounds_width = 1280,
                .bounds_height = 960,
...
#if defined(CONFIG_MPP_ENABLE_SENSOR_BF3238_ON_CSI0_USE_CHIP_CLK)
_Static_assert((CONFIG_MPP_CSI_DEV0_MCLK_NUM >= 1) &&
                   (CONFIG_MPP_CSI_DEV0_MCLK_NUM <= 3),
               "Invalid CONFIG_MPP_CSI_DEV0_MCLK_NUM");
#endif
